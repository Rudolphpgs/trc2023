...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      jsPlugins: {
        files: [
          "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/vendor/**/**/*.js",
          "!<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/vendor/min/*.js",
        ],
        tasks: ["copy:scripts", "uglify:jsPlugins"],
      },
      images: {
        files:
          "<%= sourcePath %>/<%= assetDir %>/<%= imageDir %>/**/*.{png,jpg,jpeg,gif,webp,svg}",
        tasks: ["copy:images"],
      },
      cwebp: {
        files:
      ...
      fonts: {
        files:
          "<%= sourcePath %>/<%= assetDir %>/<%= fontDir %>/**/*.{eot,svg,ttf,woff,woff2}",
        tasks: ["copy:fonts"],
      },
    },
    ...
    critical: {
      dist: {
        options: {
          base: "dist/",
          css: ["<%= distPath %>/<%= assetDir %>/<%= styleDir %>/main.css"],
        },
        ...
        files: [
          {
            ...
            flatten: true,
            src: [
              "<%= distPath %>/<%= assetDir %>/<%= styleDir %>/critical/main.css",
            ],
            dest: "<%= distPath %>/<%= assetDir %>/<%= styleDir %>/critical",
          },
        ],
      },
    },
    ...
    uglify: {
      ...
      concat: {
        ...
        files: {
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/home.js": [
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/common.js",
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/home.js",
          ],
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/page.js": [
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/common.js",
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/page.js",
          ],
        },
      },
      ...
      concatmin: {
        ...
        files: {
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/min/home.js": [
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/common.js",
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/home.js",
          ],
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/min/page.js": [
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/common.js",
            "<%= sourcePath %>/<%= assetDir %>/<%= scriptDir %>/page.js",
          ],
        },
      ...
      jsPlugins: {
        ...
        files: {
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/min/home_plugins.js":
            config.home,
          "<%= distPath %>/<%= assetDir %>/<%= scriptDir %>/min/page_plugins.js":
            config.page,
        },
      },
    },
  ...
  grunt.registerTask("serve", ["browserSync", "watch", "cwebp"]);
